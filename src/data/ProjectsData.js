...
const website = new Project(3, "🖥️", "WEBSITE", website_img,"MY PERSONAL WEBSITE", "https://www.alexyiyeonkim.com")
const websiteProject = [website]

//mobile tab
const img = require("./answer-question.png");
const mobileApp1 = new Project(0, "📱", "MOBILE", img,"Developed a social media platform that fosters genuine connections by answering questions using React (frontend framework), TypeScript (frontend language), and Firestore for the database to store data in NoSQL", "https://www.alexyiyeonkim.com/projects")
...
const movie_recommendation = new Project(2, "🤖", "Machine Learning",
